...
from pyaction.utils.ava_evaluation import object_detection_evaluation, standard_fields
...
def get_ava_eval_data(
    scores, boxes, metadata, class_whitelist, verbose=False, video_idx_to_name=None,
):
    """
