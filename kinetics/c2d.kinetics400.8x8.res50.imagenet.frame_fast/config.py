...
_config_dict = dict(
    ...
    TRAIN=dict(
        PRE_FETCH=True,
        # DATASET="Kineticsframesfast", 
        DATASET="Kineticsframes", 
        BATCH_SIZE=64,
        # BATCH_SIZE=32,
        EVAL_PERIOD=10,
        # EVAL_PERIOD=-1,
...
"""
# node-1
pyaction_run --shard_id 0 --num_shards 2 --init_method tcp://gnode08:9999
# node-2
pyaction_run --shard_id 1 --num_shards 2 --init_method tcp://gnode08:9999
"""